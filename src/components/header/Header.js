        ...
        <Col md={10} mdOffset={1}>
          <div style={{padding: '5px', backgroundColor: '#fff', color: '#8B0000'}}>
            ...
            <div style={{textAlign: 'center', verticalAlign: 'middle', backgroundColor: '#fff', display: 'flex', flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between'}}>
              <h6 style={{flex: '1', fontWeight: 'bold', fontSize: '18px', fontFamily: 'impact'}}>Closed Mon.</h6>
              <h6 style={{flex: '1', fontWeight: 'bold', fontSize: '18px', fontFamily: 'impact'}}>Tues. 4pm - 9pm</h6>
              <h6 style={{flex: '1', fontWeight: 'bold', fontSize: '18px', fontFamily: 'impact'}}>Wed. - Fri. 11am - 9pm</h6>
              <h6 style={{flex: '1', fontWeight: 'bold', fontSize: '18px', fontFamily: 'impact'}}>Sat. 12pm - 9:30pm</h6>
              <h6 style={{flex: '1', fontWeight: 'bold', fontSize: '18px', fontFamily: 'impact'}}>Sun. 2pm - 8pm</h6>
            </div>
          </div>
          <NavMenu />
        </Col>
